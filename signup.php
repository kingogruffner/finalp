...
if(isset($_POST['btn-signup']))
{
	...
	else
	{
		try
		{
			$stmt = $user->runQuery("SELECT Username, Email FROM user WHERE Username=:uname OR Email=:umail");
			...
			{     //$uname,$upass,$umail,$fname,$lname
				if($user->register($uname,$upass,$umail,$fname,$lname)){	
...
<div class="container">
        ...
        <form method="post" class="form-signin">
            <h2 class="form-signin-heading">Sign up for the SLIME!</h2><hr />
            <?php
			if(isset($error))
			{
